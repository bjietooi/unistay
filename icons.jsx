...
const I = {
  ...
  ChevronLeft: (p) => (
    <Icon
      {...p}
      d={<polyline points="15 6 9 12 15 18" />}
    />
  ),
  ChevronRight: (p) => (
    <Icon
  ...
  Badminton: (p) => (
    <Icon
      ...
      d={
        <>
          <path d="M12 21a2.5 2.5 0 0 0 2.5-2.5L13.5 11h-3l-1 7.5A2.5 2.5 0 0 0 12 21z" />
          <path d="M10.5 11 7.5 4M13.5 11 16.5 4M12 11V3.5" />
        </>
      }
    />
  ),
  Fence: (p) => (
    <Icon
      ...
      d={
        <>
          <path d="M6 21V6l1.5-2L9 6v15" />
          <path d="M15 21V6l1.5-2L18 6v15" />
  ...
  Flame: (p) => (
    <Icon
      ...
      d={
        <>
          <path d="M12 3c.6 3 2.4 4.1 3.8 5.7A6.6 6.6 0 0 1 17.5 13a5.5 5.5 0 0 1-11 0c0-1.7.8-3 1.7-4" />
          <path d="M12 20a2.7 2.7 0 0 1-2.7-2.7c0-1.7 1.5-2.5 2.7-4.3 1.2 1.8 2.7 2.6 2.7 4.3A2.7 2.7 0 0 1 12 20z" />
        </>
      }
    />
  ),
    ...
    <Icon
      ...
      d={
        <>
          ...
          <path d="M7 2.5c-.7 1-.7 1.8 0 2.8M11 2.5c-.7 1-.7 1.8 0 2.8" />
        </>
      }
    />
  ),
